...
flags.DEFINE_string('datasource', 'sinusoid', 'sinusoid or omniglot or miniimagenet or weather')
...
def train(model, saver, sess, exp_string, data_generator, resume_itr=0):
    ...
    SAVE_INTERVAL = 1000
    if FLAGS.datasource == 'sinusoid' or FLAGS.datasource == 'weather' :
        PRINT_INTERVAL = 100#1000
        PRINT_FIG_INTERVAL = 500  # 1000
    ...
    for itr in range(resume_itr, FLAGS.pretrain_iterations + FLAGS.metatrain_iterations):
        ...
        if (itr!=0) and itr % TEST_PRINT_INTERVAL == 0 and (FLAGS.datasource !='sinusoid' or FLAGS.datasource !='weather'):
...
def test(model, saver, sess, exp_string, data_generator, test_num_updates=None):
    ...
    for _ in range(NUM_TEST_POINTS):
        ...
        else:  # this is for sinusoid or weather
